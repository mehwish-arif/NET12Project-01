    ...
    public class ApplicantWorkHistoryRepository : IDataRepository<ApplicantWorkHistoryPoco>
    {
        ...
        public IList<ApplicantWorkHistoryPoco> GetAll(params Expression<Func<ApplicantWorkHistoryPoco, object>>[] navigationProperties)
        {
            ...
            while (rdr.Read())
            {
                ...
                poco.StartMonth = (short)(rdr.IsDBNull(7) ? null : (int?)rdr.GetInt16(7));
                poco.StartYear = (int)(rdr.IsDBNull(8) ? null : (int?)rdr.GetInt32(8));
                poco.EndMonth = (short)(rdr.IsDBNull(9) ? null : (int?)rdr.GetInt16(9));
                poco.EndYear = (int)(rdr.IsDBNull(10) ? null : (int?)rdr.GetInt32(10));
